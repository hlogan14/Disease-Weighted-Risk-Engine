...
# Updated with exact confirmed column names from your uploaded CSVs.
# =============================================================================
...
def validate():
    ...
    for name, expected_cols in EXPECTED.items():
        ...
        try:
            ...
            if extra:
                print(f"  ℹ  Unused columns (ignored by model): {sorted(extra)}")
    ...
    if all_ok:
        ...
        print("❌ Some columns are missing. Paste this output back to Copilot for help.")
