...
DISEASE_DESCRIPTIONS = {
    ...
    "Stroke": (
        ...
        "Irregular heartbeat (atrial fibrillation), smoking, and high blood sugar "
        "significantly increase stroke risk."
    ),
    "Alzheimer's Disease": (
        "Alzheimer's is the most common form of dementia, causing progressive memory "
        "and cognitive decline. Family history, age, and cardiovascular health are "
        "key risk factors. Mental stimulation and physical activity are among the "
        "strongest known protective factors."
    ),
}
...
st.markdown(
    ...
    "**exposure rating** (High / Medium / Low) for six chronic diseases "
...
with st.form("sentinel_form"):
    ...
    with col3:
        ...
        family_history_heart = st.selectbox(
    ...
    with col5:
        ...
        family_history_alzheimers = st.selectbox(
            "Does anyone in your immediate family have Alzheimer's or dementia?",
            ["No", "Yes", "Not Sure"]
        )
    with col6:
        ...
        irregular_heartbeat = st.selectbox(
            "Have you ever been told you have an irregular heartbeat or atrial fibrillation?",
            ["No", "Yes", "Not Sure"]
        )
    ...
    with col8:
        ...
        mental_activity = st.selectbox(
            "How often do you engage in mentally stimulating activities? (reading, puzzles, learning)",
